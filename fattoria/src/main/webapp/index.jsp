...
<body style="margin: 20px">
	...
	<section>
		...
		<ol>
			...
			<li>
				<p>(DIFERENCIAL) Você pode deixar seu código rodando na web, para que possamos analisá-lo. (AWS, Heroku, Openshift...)
				</p>
			</li>
	...
	<section>
		...
		<ol>
			...
			<li>
				<p>Deve conter validações nos formulários tanto no frontend quanto no backend</p>
			</li>
			<li>
